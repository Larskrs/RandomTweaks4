...
public class SethomeCommand extends Command {
        ...
        public void execute(CommandSender sender, String[] args) {
            if (sender instanceof Player) {
                ...
                if (ModuleManager.getModuleByName("HomeModule").getModuleFile().getConfig().getInt("maxHomes") > playerHomes) {
                ConfigTools.setLocationToConfSection(DataFileManager.getConfig(), "player-data." + p.getUniqueId() + ".homes." + homeName, p.getLocation()); DataFileManager.saveFile(); DataFileManager.reloadFile();
